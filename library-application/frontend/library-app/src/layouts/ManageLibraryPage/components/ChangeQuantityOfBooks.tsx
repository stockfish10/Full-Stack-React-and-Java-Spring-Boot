...
export const ChangeQuantityOfBooks = () => {
    ...
    useEffect(() => {
        const fetchBooks = async () => {
            const baseUrl: string = `http://localhost:8080/api/bookEntities?page=${currPage - 1}&size=${booksPerPage}`;
    ...
    let lastItem = booksPerPage * currPage <= totalAmountOfBooks ? booksPerPage * currPage : totalAmountOfBooks;
