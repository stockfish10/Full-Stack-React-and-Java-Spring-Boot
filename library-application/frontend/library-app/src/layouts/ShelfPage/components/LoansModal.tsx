                        ...
                        <div className="container">
                            <div className="mt-3">
                                ...
                                <div className="list-group mt-3">
                                    ...
                                    } data-bs-dismiss="modal" className={props.shelfCurrentLoan.daysLeft < 0 ? "list-group-item list-group-item-action inactiveLink" : "list-group-item list-group-item-action"}>
